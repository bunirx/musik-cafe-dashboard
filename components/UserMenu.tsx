  ...
  return (
    <div className="relative" data-user-menu>
      <button
        ...
        className="w-14 h-14 rounded-full bg-gradient-to-br from-aqua to-accent-blue flex items-center justify-center text-white font-bold hover:shadow-lg hover:shadow-aqua/50 transition-all hover:scale-110 ml-2"
        title={userName}
      >
        {userAvatar ? (
          <img
