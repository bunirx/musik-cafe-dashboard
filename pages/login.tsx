      ...
      <Layout>
        <div className="min-h-[60vh] flex items-center justify-center">
          <div className="w-full max-w-md">
            <div className="bg-gradient-to-br from-darker-blue to-dark-blue border border-aqua/30 rounded-3xl p-8 space-y-8">
              {/* Header */}
              <div className="text-center space-y-3">
                <div className="text-6xl">🎵</div>
                <h1 className="text-3xl font-bold gradient-text">Musik Cafe</h1>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full py-4 bg-gradient-to-r from-aqua to-accent-blue text-white font-bold rounded-2xl hover:shadow-lg hover:shadow-aqua/50 transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
              >
              ...
              <div className="text-center text-sm text-gray-400 space-y-2">
                <p>We only access your server list and basic info.</p>
                <p>You need admin or owner access to manage a server.</p>
              </div>
            </div>
          </div>
        </div>
